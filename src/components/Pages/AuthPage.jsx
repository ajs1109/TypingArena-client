...
const AuthPage = () => {
  ...
  const handleSignIn = async (e) => {
    try {
      ...
      const res = await axios.post("https://typingarena-server.onrender.com/api/auth", newData);
  ...
  const handleSignUp = async (e) => {
    try {
      ...
      const res = await axios.post("https://typingarena-server.onrender.com/api/users", newData);
      console.log(res)
      localStorage.setItem("token", res.data.data);
      console.log(res)
      window.location = "/game";
